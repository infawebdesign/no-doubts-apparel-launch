...
function Contact() {
  ...
  return (
    <div className="mx-auto max-w-[1600px] px-4 py-12 sm:px-8 sm:py-20">
      <p className="label text-magenta">Get in touch</p>
      ...
      <div className="mt-12 grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)]">
        ...
        >
          <div className="grid gap-6 sm:grid-cols-2">
            <label className="block">
              ...
              <input
                required
                className="mt-2 w-full border border-input bg-transparent px-4 py-3 text-sm focus:border-lime focus:outline-none"
              />
            </label>
            <label className="block">
          ...
          <label className="block">
            ...
            <select className="mt-2 w-full border border-input bg-background px-4 py-3 text-sm focus:border-lime focus:outline-none">
          ...
          <button
            type="submit"
            className="display w-full bg-lime px-8 py-4 text-lg text-ink transition-colors hover:bg-magenta hover:text-bone"
          >
            Send message
          </button>
        ...
        <aside className="space-y-8">
          <div className="border border-border p-6">
            <h2 className="display text-xl text-lime">Email</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              [Contact email to be provided]
            </p>
          </div>
          <div className="border border-border p-6">
            <h2 className="display text-xl text-cobalt">Social</h2>
            <p className="mt-3 text-sm text-muted-foreground">
              [Social handles to be provided]
            </p>
          </div>
          <div className="border border-border p-6">
            <h2 className="display text-xl text-magenta">Orders</h2>
            <p className="mt-3 text-sm text-muted-foreground">
